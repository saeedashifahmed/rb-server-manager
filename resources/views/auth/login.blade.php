...
@section('form')
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
        ...
        <div class="flex items-center">
            <input id="remember" name="remember" type="checkbox"
                   class="h-4 w-4 rounded text-brand-600 focus:ring-brand-500 border-gray-300">
    ...
    <p class="mt-6 text-center text-sm text-gray-600">
        ...
        <a href="{{ route('register') }}" class="font-semibold text-brand-600 hover:text-brand-500">Register</a>
    </p>
@endsection
